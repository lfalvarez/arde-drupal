 ...
 */
?>
<div class="panel-display parrot-panels minipanels <?php print isset($view_mode) ? $view_mode : ''; ?> minipanel-two-50 clearfix" <?php if (!empty($css_id)): print "id=\"$css_id\""; endif; ?>>
